...
#define d4_ 0.10915
#define d5_ 0.09465
#define d6_ 0.1223    //TODO: remembed that I changed this from 0.0823 to 0.1223 in order to take microphone array into account
...
#define MAX_DIST 30.8/2.0 // MAX_DIST > distance(high,low) = 4*sqrt(6)*PI/2.0
#define INF 1.0/0.0
